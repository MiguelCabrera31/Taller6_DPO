...
public class VentanaPrincipal extends JFrame
{
    ...
    public void mostrarVentanaMapa( )
    {
        ...
        {
            // La ventana ya existe: refrescamos su contenido
            ventanaMapa.toFront();
            ventanaMapa.repaint();
        }
    }
    ...
    //  Llamado por VentanaAgregarRestaurante al presionar “Crear”
    public void agregarRestaurante( String nombre, int calificacion, int x, int y, boolean visitado )
    {
        ...
        // Actualizar interfaz
        actualizarRestaurantes();
        pLista.seleccionarRestaurante(r);

        // Si la ventana de mapa está abierta, refrescarla
        if (ventanaMapa != null && ventanaMapa.isVisible())
        {
            ventanaMapa.repaint();
        }
    ...
    //  Método que usa VentanaMapa para pedir listas
    ...
    //  Sincroniza la lista y los detalles
